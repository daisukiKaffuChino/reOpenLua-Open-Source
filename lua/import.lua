...
LuaActivity = luajava.bindClass("github.daisukiKaffuChino.reopenlua.LuaActivity")
...
local function env_import(env)
    ...
    --append(packages, 'com.open.lua.service.')
...
if activity then
    function _M.print(...)
        ...
        activity.sendMsg("LuaPrint",msg)--请勿替换reOpenLua的修改！
    end
end
